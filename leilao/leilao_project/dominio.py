...
class Usuario:
    ...
    def propoe_lance(self, leilao, valor):
        if not self._valor_eh_valido(valor):
            raise LanceInvalido("Não é possível propor um lance com um valor maior do que o valor em carteira!!!")
...
class Leilao:
    ...
    def _lance_eh_valido(self, lance):
        return not self.__lances or self._usuarios_diferentes(lance) and self._valor_maior_que_o_lance_anterior(lance)
